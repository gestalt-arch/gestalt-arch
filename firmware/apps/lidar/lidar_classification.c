...
/*
	DEFINES ARE STILL POPULATED WITH SIMULATION DATA.
*/

#define NUM_ELEMENT 429
...
#define delta .35
#define delta_ .2
classification_t classify(float* distance, float* theta, uint8_t num_objects, coordinate* cord) {
	int found = 0;
	int in_object = 0;
	...
	if (found <= num_objects) {
		...
		get_loc(cord, pole1_theta, pole2_theta);
